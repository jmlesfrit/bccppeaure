 ...
 */
final class Version20210521073609 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commissaire_priseur (id INT AUTO_INCREMENT NOT NULL, pr�nom VARCHAR(45) NOT NULL, nom VARCHAR(45) NOT NULL, r�gion VARCHAR(45) NOT NULL, d�partement VARCHAR(45) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE acheteur ADD id INT AUTO_INCREMENT NOT NULL, ADD adress_email VARCHAR(45) NOT NULL, ADD prenom VARCHAR(45) NOT NULL, ADD password VARCHAR(45) NOT NULL, ADD type_payement VARCHAR(45) NOT NULL, DROP idAcheteur, DROP Prénom, DROP TypePayement, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE catégorie (idCatégorie INT NOT NULL, Nom VARCHAR(45) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, PRIMARY KEY(idCatégorie)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE acheteur ADD idAcheteur INT NOT NULL, ADD Prénom VARCHAR(45) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, ADD TypePayement VARCHAR(45) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, DROP id, DROP adress_email, DROP prenom, DROP password, DROP type_payement');
